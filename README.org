...
On the other hand, [[https://htmx.org/][htmx]] incrementally adds dynamic features to otherwise static web pages, which is in my comfort zone.
...
* Developing
Prerequisites: [[https://www.postgresql.org/][postgres]], [[https://github.com/air-verse/air][air]]

Run: =./developing.sh= to recreate the db, compile, and run (recompiling as files change).
